...
const productImages: Record<string, { url: string; filename: string; alt: string }> = {
  ...
  'roller-shutters': {
    url: 'https://images.pexels.com/photos/32494216/pexels-photo-32494216.jpeg?auto=compress&cs=tinysrgb&w=1200',
    filename: 'roller-shutters.jpg',
    alt: 'Roller shutters on a building',
  },
  'indoor-screens': {
    url: 'https://images.pexels.com/photos/24182748/pexels-photo-24182748.jpeg?auto=compress&cs=tinysrgb&w=1200',
    filename: 'indoor-screens.jpg',
    alt: 'Indoor roller blind on a window',
  },
  parasols: {
    url: 'https://images.pexels.com/photos/30952735/pexels-photo-30952735.jpeg?auto=compress&cs=tinysrgb&w=1200',
    filename: 'parasols.jpg',
    alt: 'Outdoor parasol in a cafe terrace',
  },
  pergola: {
    url: 'https://images.pexels.com/photos/34169602/pexels-photo-34169602.jpeg?auto=compress&cs=tinysrgb&w=1200',
    filename: 'pergola.jpg',
    alt: 'Modern pergola in a garden',
  },
  maintenance: {
    url: 'https://images.pexels.com/photos/7859953/pexels-photo-7859953.jpeg?auto=compress&cs=tinysrgb&w=1200',
    filename: 'maintenance.jpg',
    alt: 'Technician performing maintenance work',
  },
  repairs: {
    url: 'https://images.pexels.com/photos/34404157/pexels-photo-34404157.jpeg?auto=compress&cs=tinysrgb&w=1200',
